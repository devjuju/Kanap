...
function initialize(products) {
  ...
  // ceux-ci contiennent les résultats du filtrage par catégorie et terme de recherche
  ...
  // Pour commencer, définissez finalGroup sur l'intégralité de la base de données de produits
  // puis exécutez updateDisplay(), afin que TOUS les produits soient affichés initialement.
  finalGroup = products;
  updateDisplay();

  // Définissez les deux sur un tableau vide, à temps pour que les recherches soient exécutées
  categoryGroup = [];
  finalGroup = [];

  // lorsque le bouton de recherche est cliqué, invoquez selectCategory() pour démarrer
  // une recherche en cours pour sélectionner la catégorie de produits que nous voulons afficher
